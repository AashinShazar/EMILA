...
#ifdef PWM_5_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* PWM_5_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void PWM_5_Init(void) 
{
        ...
        ctrl = PWM_5_CONTROL & ((uint8)(~PWM_5_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~PWM_5_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void PWM_5_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                PWM_5_CONTROL &= ((uint8)(~(PWM_5_CTRL_CMPMODE1_MASK |
                                            PWM_5_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    uint16 PWM_5_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(PWM_5_COUNTERCAP_LSB_PTR_8BIT);
...
void PWM_5_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_5_STATUS_PTR));
    }
